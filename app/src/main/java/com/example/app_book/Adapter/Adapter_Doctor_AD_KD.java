...
public class Adapter_Doctor_AD_KD extends RecyclerView.Adapter<Adapter_Doctor_AD_KD.Myholder> {
    Context context;
    ...
    public Adapter_Doctor_AD_KD(Context context, List<Model_doctor> userList) {
    ...
    @NonNull
    @Override
    public Adapter_Doctor_AD_KD.Myholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_doctor, parent,false);

        return new Adapter_Doctor_AD_KD.Myholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Doctor_AD_KD.Myholder holder, int i) {
