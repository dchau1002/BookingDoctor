...
public class Adapter_LichKhamofUser extends RecyclerView.Adapter<Adapter_LichKhamofUser.Myholder> {
    Context context;
    ...
    public Adapter_LichKhamofUser(Context context, List<Model_LichKhamUS> userList) {
        this.context = context;
        this.userList = userList;
        benhanh = FirebaseDatabase.getInstance().getReference("Doctor");

    }
    @NonNull
    @Override
    public Adapter_LichKhamofUser.Myholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_lichkham_of_us, parent,false);

        return new Adapter_LichKhamofUser.Myholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_LichKhamofUser.Myholder holder, int i) {
       ...
       holder.tvv1.setText("Lịch Hẹn: "+userList.get(i).getNgaykham());
        ...
        final Query ref = benhanh.orderByChild("uid").equalTo(iddt);
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    holder.tvv4.setText("Địa Chỉ: "+ bbb);
