...
public class Choose_Doctor extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        RecyclerView rcv_user;
        Adapter_Choo_DT adapter_user;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            adapter_user = new Adapter_Choo_DT(this, userList);
        ...
        private void checkUserStatus(){
            ...
            if(user != null){
                ...
                startActivity(new Intent(Choose_Doctor.this, PharmacyActivity.class));
                finish();
            }
        }
