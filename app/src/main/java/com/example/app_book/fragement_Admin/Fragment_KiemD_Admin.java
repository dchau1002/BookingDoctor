...
import com.example.app_book.Adapter.Adapter_Doctor_AD_KD;
...
public class Fragment_KiemD_Admin extends Fragment {
    ...
    Adapter_Doctor_AD_KD Adapter_LichkhamOfUS;
    List<Model_doctor> Model_LichKhamUS;
    public Fragment_KiemD_Admin() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kiemduyet_admin, container, false);
        ...
        LichkhamUS = view.findViewById(R.id.rcvlhus_2);
//        LichkhamUS.setHasFixedSize(true);
        ...
        Adapter_LichkhamOfUS = new Adapter_Doctor_AD_KD(getContext(), Model_LichKhamUS);
        showlichkham();
        /////////////////////////////
