...
public class Dashboard_Doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle actionBarDrawerToggle = new ActionBarDrawerToggle(Dashboard_Doctor.this
        ...
        mesage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Dashboard_Doctor.this, ShowUserChatActivity.class);
        ...
        navigationView2.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.pro1:
                        Intent intent1 = new Intent(Dashboard_Doctor.this, Profile_Doctor.class);
                    ...
                    case  R.id.pro2:
                        Intent intent = new Intent(Dashboard_Doctor.this, LichSu_User.class);
...
//                        startActivity(intent);
        ...
        BottomNavigationView navigationView = findViewById(R.id.nav_bottom_dt);
        ViewPager viewPager = findViewById(R.id.viewpagerbottomdt);
        Adapter_menubottom_Doctor adapter_ab0 = new Adapter_menubottom_Doctor(getSupportFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        ...
                        Fragment_home_Doctor homeFragment = (Fragment_home_Doctor) viewPager.getAdapter().instantiateItem(viewPager,0);
                        homeFragment.reloadata();
                        break;
                    case 1:
                        navigationView.getMenu().findItem(R.id.nav_lichkham).setChecked(true);
                        Fragment_Lichkham_DT profileFragment = (Fragment_Lichkham_DT) viewPager.getAdapter().instantiateItem(viewPager,1);
                        profileFragment.reloadata();
                        break;
                    case 2:
                        navigationView.getMenu().findItem(R.id.nav_videos).setChecked(true);
                        Fragment_MN_lichkham_DT fragment_mn_lichkham_dt = (Fragment_MN_lichkham_DT) viewPager.getAdapter().instantiateItem(viewPager,2);
                        fragment_mn_lichkham_dt.reloadata();
                        break;
                    case 3:
                        navigationView.getMenu().findItem(R.id.nav_discovers).setChecked(true);
                        Fragment_hoso_Doctor friendsFragment = (Fragment_hoso_Doctor) viewPager.getAdapter().instantiateItem(viewPager,3);
                        friendsFragment.reloadata();
                        break;
                    case 4:
                        navigationView.getMenu().findItem(R.id.nav_notications).setChecked(true);
                        Fragment_notification_Doctor NoticationsFragment = (Fragment_notification_Doctor) viewPager.getAdapter().instantiateItem(viewPager,4);
    ...
    private void checkUserStatus(){
        FirebaseUser user = firebaseAuth.getCurrentUser();
            ...
            startActivity(new Intent(Dashboard_Doctor.this, PharmacyActivity.class));
            finish();
        }
